  ...
  const handleEditRoom = async () => {
    ...
    dispatch(editRoom({ room_id: room.room_id, data })).then((result) => {
      if (result.payload) {
        ...
        setSite("Zhenite 1");
        setInputs([]);
        dispatch(fetchRooms({ offset: 0, limit: 10, filter: "", search: "" }));
      }
    });
  };
            ...
            <div className=" flex w-60  h-full ">
              <form className="flex flex-col gap-2 w-full overflow-y-scroll no-scrollbar ">
                ...
                <div className="flex flex-col w-full justify-start">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      setLocation(() => {
                        setSite(
                          e.target.value == "Lac" ? "Zhenite 1" : "Charguia 1"
                        );
                ...
                <div className="flex flex-col w-full justify-start">
                  ...
                  >
                    <option
                      disabled={location == "Charguia"}
                      className={`${location == "Charguia" && "hidden"}`}
                      value="Zhenite 1"
                    >
                      Zhenite 1
                    </option>
                    ...
                    <option
                      disabled={location == "Lac"}
                      className={`${location == "Lac" && "hidden"}`}
                      value="Charguia 1"
                    >
                      Charguia 1
                    </option>
